  ...
  useGSAP(
    () => {
      ...
      timeline
        ...
        .from(".contact__form", { x: -100, opacity: 0 },
          {opacity:1,x:0}
        )
       
        .fromTo(".option", { x:100, opacity:0 },
        ...
        <div className="contact__form">
          <div className="contact__form__top">
            ...
            <p className="text__muted">
              Have questions or need assistance? Reach out to us for any
              inquiries related to our JN CSC services; we are here to help!
            </p>
          </div>
        ...
        <div className="contact__options">
          {contacts.map((contact, index) => (
            <div className="option" key={index}>
              ...
              <div>
                <a href={contact.demoLink}  className="btn btn__primary">
                  Contact Us
                </a>
